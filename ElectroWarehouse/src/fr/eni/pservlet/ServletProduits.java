...
/**
 * Servlet implementation class ServletProduits
 */
@WebServlet("/ServletProduits")
public class ServletProduits extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// intanciation d\"un objet produit
		Produit produit = new Produit("ELITEBOOK 820 G1", Categorie.PC_portable, "HP", 2019, 599.00, 1, "/ElectroWarehouse/images/product01.png", "Intel Core i5-4200U 1.60GHz / 8Go RAM DDR3 / 320Go HDD / 12.5'");
		...
		out.println("<table>");
		//out.println("<caption>Nos Produits</caption>
		out.println("<thead>");
		out.println("<tr>");
		out.println("<th></th>");
